...
if __name__ == '__main__':
	...
	r1.cmd('./router &')
	time.sleep(0.2)
	print h1.cmd('ping 10.0.1.1 -c 5')
	print h1.cmd('ping 10.0.2.22 -c 5')
	print h1.cmd('ping 10.0.3.33 -c 5')
	print h1.cmd('ping 10.0.2.11 -c 5')
	print h1.cmd('ping 10.0.4.1 -c 5')
	net.stop()