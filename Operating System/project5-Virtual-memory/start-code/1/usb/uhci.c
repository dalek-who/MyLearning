...
void uhci_port_command(struct usb_hub *uhub, int port,
  ...
  switch(command) {
    ...
    case USB_PORT_CLEAR_RESET: uhci_port_clear_bit(uh, port, UHCI_PORTSC_RESET); break;
    case USB_PORT_ENABLE: uhci_port_set_bit(uh, port, UHCI_PORTSC_ENABLE); break;
    case USB_PORT_DISABLE: uhci_port_clear_bit(uh, port, UHCI_PORTSC_ENABLE); break;
    default:;
  }
  return;
}
