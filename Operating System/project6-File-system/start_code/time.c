/*	time.c
	...
	Note: A number of comments irrelevant to the OS projects (but certainly
	relevant to Linux!) have been removed from this adaptation, which
	originally came from Stanislav Sokolov (who got the code from the Linux kernel).
